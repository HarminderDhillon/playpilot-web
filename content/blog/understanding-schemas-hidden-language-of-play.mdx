...
- **Transporting** — moving objects from one place to another (carrying blocks across the room, filling and emptying containers)
- **Trajectory** — exploring movement through space (throwing, dropping, rolling, pouring)
- **Enclosing** — surrounding, wrapping, or containing objects and spaces (building fences around animals, wrapping toys)
- **Rotation** — spinning, turning, twisting (watching wheels turn, stirring, rolling down hills)
- **Connecting** — joining things together (train tracks, linking chains, taping paper together)
- **Transforming** — changing the state of materials (mixing colours, adding water to sand, cooking)
- **Positioning** — arranging objects in particular patterns (lining up cars, organising by colour)
