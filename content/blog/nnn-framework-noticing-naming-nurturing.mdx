...
- **Developmental domains** — social-emotional, cognitive, physical, language, creative
- **Play schemas** — trajectory, enclosing, transporting, rotation
- **Dispositions** — curiosity, persistence, collaboration, creativity
- **Curriculum connections** — links to FLIGHT, EYLF, Te Whariki, or other frameworks
...
- **Extending the play** — adding materials or provocations that build on the child's interest
- **Creating connections** — linking a child's current exploration to a future experience
- **Involving families** — sharing the observation with parents so they can extend learning at home
- **Reflecting with colleagues** — discussing the observation to gain new perspectives
